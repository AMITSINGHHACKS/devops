...
Check console output at $BUILD_URL to view the results.''', cc: 'aniketsingh78698@gmail.com', from: '', replyTo: '', subject: '$PROJECT_NAME - Build # $BUILD_NUMBER - $BUILD_STATUS!', to: 'as216889@gmail.com'
    }
}
}
